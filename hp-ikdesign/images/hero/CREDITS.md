# ヒーロー写真素材のクレジット・ライセンス

すべて**仮素材**です。差し替える際は同名でファイルを上書きしてください
（HTMLの変更不要）。差し替え後、このファイルの該当行も更新してください。
...
## 帰属表示が必要な素材（CC BY 2.0）

**hero-akiya.jpg** — 公開する場合は以下のクレジット表記が必要です
（フッター等、利用者が確認できる場所に記載）:

> 写真: "An abandoned house" by Su--May (CC BY 2.0)
> https://commons.wikimedia.org/wiki/File:An_abandoned_house_(7385274366).jpg

- 作者: Su--May (from London, UK)
- ライセンス: CC BY 2.0 — https://creativecommons.org/licenses/by/2.0
- 原本: https://commons.wikimedia.org/wiki/File:An_abandoned_house_(7385274366).jpg

※ 自社撮影の空き家写真に差し替える場合は、このクレジットは不要になります。
